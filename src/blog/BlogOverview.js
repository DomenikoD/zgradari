...
const posts = [
  ...
  },
  {
    ...
    content:
      "Kada ste upisani suvlasnik, što je vidljivo na ZK ulošku, predstavnik stanara Vas poziva na Zgradare. U odjeljku Dokumentacija, vidljivi su Vam tlocrti zgrade (dobiveni iz Arhive grada), upute gdje Vam se protežu instalacije, okna, nosivi zidovi i sl. Predstavnik stanara je upravo učitao dokumenat rasporeda čišćenja snijege, upute u slučaju potresa, važne kontakte domara, kotlovničara i sl. Tu vidite i dokument o puštanju grijanja i vrijeme kad možete zamijeniti dotrajale radijatore. Nemate nikakvog stresa pred nadolazeću zimu, i pritisak da sa upitnim domarom na silu dogovarate i mijenjate ventile, jer oni baš sutra puštaju grijanje, a baš Vaš stan je kritičan. Stoga, molim Vas pripremite 2.000,00 kuna da to odradimo za Vas, da se ostali stanari ne smrzavaju.",
  ...
  },
  {
    ...
    content:
      'Ovaj slučaj izlazi iz domene Zgradara i ulazi u kompliciranu kaljužu komunalnih struktura (reciklažna dvorištva, teoretski, zaprimaju minimalne količine, doslovno teretni prostor automobila za određeni otpad u polugodišnjem roku. U praksi, budite neprimjetni, donosite umjereno, dok Vas do prijetnje "ne zapišu"). Kako nebi zvali " Dečke od riječi" ili " Besplatan odvoz otpada" jer ništa od toga nije besplatno i besplatno ne postoji, jer ako je besplatno - onda to plačaju drugi. Uglavnom, na Zgradarima, na Vašim korisničkim stranicama u odjeljku Obavijesti nalazite informacije o odvozu glomaznog otpada, šute i sl, odgovarajuće brojeve komunalnih službi i registriranih tvrtki.',
  ...
  },
  {
    ...
    content:
      'Socijalno-pravno-fizikalni interes. Biti socijalno osjetljiv i povećati kvalitetu zajedničkog življenja je temelj ove platforme. Evo nekoliko osjetljivih pitanja. Smije li predstavnik stanara braniti nešto što je on sebi napravio ili okoristio. Kako etažirati zgradu i znati koliko je točno tvoje. Kako sa malom pričuvom napraviti velike stvari. Uložiti li ili ne veliku svotu novaca u energetsku efikasnost, pa je "dobivati" nazad u komadićima. Pručuva je 0.54% godišnje od vrijednosti nekretnine - vrijednost je rasla ali pričuva nije. Parkiranje i opstruiranje zajedničkog neetažiranog vlasništva. Veliki stanar ima jacuzzi i psa, a mali tuš kadu - zajedničko brojilo vode po broju prijavljenih članova. Crveni križ donosi hranu u miljunski stan. Rušen nosivi zid, statika i osiguranje od potresa',
